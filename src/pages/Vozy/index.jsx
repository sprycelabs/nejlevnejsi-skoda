      ...
      <div className="relative bg-gradient-to-br from-[#0d1f10] via-[#1a3d1e] to-[#0a1508] overflow-hidden pt-28 sm:pt-32 pb-10 sm:pb-14">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-6">
            {[
              { value: '2026', label: 'rok výroby všech vozů', mobileHide: false },
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <span className="bg-white/20 text-white text-xs font-bold px-2 py-0.5 rounded-full whitespace-nowrap">jen 8 kuponů!</span>
                  </div>
